...
const baseResponse = require('../../common/baseResponseStatus');
const { response, errResponse } = require('../../common/response');
...
exports.createUser = async function (email, password, nickname, phone_number) {
  try {
    // 이메일 중복 확인
